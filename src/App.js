        ...
        >
          {[
            ...
            },
            {
              ...
              cuisine: "Turkish",
              description:
                "Aİskender Kebab is a Turkish dish featuring thinly sliced lamb or beef, served over pita bread, topped with yogurt and tomato sauce.",
            },
          ].map((dish, index) => (
            <div
              key={index}
